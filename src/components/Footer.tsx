...
export default function Footer(): React.ReactElement {
  ...
  // ------------ UI ------------
  return (
    <div className="w-full h-[659px] rounded-[95px] px-[72px] pt-[57px] pb-[49px] flex flex-col">
      <div id="contacts" className="w-full h-[366px] flex justify-between">
        {/* LEFT */}
        <div className="w-[424px] h-full flex flex-col">
          <h2 className="text-5xl font-bold mb-[32px]">Наши контакты:</h2>

          <div className="text-xl h-[188px] w-[370px]">
            <p className="mb-[20px] font-bold text-lg">Будем рады видеть Вас в нашем офисе:</p>
          ...
          <div className="w-[273.09px] mt-[30px] gap-x-[22.52px] h-[61px] flex justify-between items-center">
            {Images.map((img, index) => (
              <a key={index} href={img.href} style={{ width: img.width, height: img.height }}>
        ...
        {/* RIGHT MAP */}
        <div className="w-[479px] h-[260px] my-auto relative rounded-[20px] overflow-hidden bg-[#f6f7f8] shadow-sm">
          <div
            ref={mapRef}
      ...
      {/* ---------- BOTTOM FORM ---------- */}
      <div className="w-[752px] h-[158px] rounded-[19px] bg-[#02A653] mx-auto mt-[29px] px-[37px] pt-[25px] pb-[35px] flex flex-col">
        <p className="text-xl font-bold mx-auto text-center text-white">
          Оставьте свой номер и получите консультацию мастера:
        </p>

        <div className="flex gap-x-[28px] w-full h-[58px] mt-[10px] items-center justify-center">
          {/* INPUT */}
          <input
            type="tel"
            inputMode="tel"
            ...
            className="w-[326px] h-[58px] rounded-[39px] pl-[29px] text-[18px] bg-white/10 outline-none 
          ...
          <button
            ...
            className={`w-[326px] h-[58px] text-[#02A653] bg-white rounded-[39px] font-extrabold text-lg 
